...
<div class="flex h-screen w-full flex-col items-center justify-center">
	<div class="flex w-[350px] max-w-[550px] flex-col justify-center gap-6 min-[700px]:w-1/2">
		...
		<div class="flex w-full justify-center rounded-lg border border-neutral-800">
			<form
				class="flex w-11/12 flex-col items-center justify-center gap-6 py-12 text-white min-[700px]:w-3/4 min-[700px]:py-20"
			>
				...
				<label class="flex w-full flex-col gap-1.5">
					...
					<input
						bind:value={email}
						class="h-12 w-full rounded-lg border border-neutral-800 bg-transparent pl-1.5 outline-none ring-voulr-blue transition-all duration-300 ease-in-out focus:ring-2"
					/>
